...
public class ScenarioGenerator {
    ...
    public Map<String, Object> generate() throws Exception {
        ...
        openAPI.getPaths().forEach((path, pathItem) -> {
            ...
            for (Map.Entry<PathItem.HttpMethod, io.swagger.v3.oas.models.Operation> entry : operations.entrySet()) {
                ...
                positiveScenario.put("datasets", List.of(Map.of(
                        ...
                        "desired_outcome", getResponseExample(operation, getSuccessStatusCode(operation), openAPI)
                ...
                if (schema != null) {
                    List<Map<String, Object>> negativeDatasets = generateNegativeTestCases(schema, requestBody, openAPI, operation);
        ...
        for (Map.Entry<String, List<Map<String, Object>>> entry : tagToTestCases.entrySet()) {
            ...
            String fileName = "generated-testcases-" + entry.getKey().toLowerCase().replaceAll("\\s+", "_") + DateTime +  ".json";
